      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            >
              <div>
                <h2 className="text-3xl md:text-5xl font-bold text-foreground tracking-tight font-mono uppercase">
              ...
              <div className="space-y-6 text-sm md:text-base text-muted leading-relaxed font-mono">
                <p className="first-letter:text-4xl first-letter:font-black first-letter:text-primary first-letter:mr-3 first-letter:float-left">
                  I’m a <span className="text-foreground font-bold">Computer Science Engineering student</span> and builder focused on creating real-world digital solutions. I enjoy turning ideas into scalable products, especially in web development and automation systems.
                </p>
                
                <p>
                  I have developed systems like a <span className="text-primary font-bold underline decoration-primary/30 underline-offset-4">certificate management platform</span> that automates issuance and verification, and I’m currently working on scaling it into a SaaS product. My work goes beyond coding — I focus on building complete, usable systems that solve real problems.
                </p>

                <p>
                  I’m also exploring emerging technologies like <span className="text-secondary font-bold">Brain-Computer Interfaces (BCI)</span>, with a growing interest in understanding how human cognition can interact directly with computing systems.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6">
                  <div className="glass p-5 border-l-2 border-primary/40 bg-primary/5">
                    ...
                    <p className="text-sm text-muted">Execution over theory. Focusing on system design, problem-solving, and continuous improvement.</p>
                  </div>
                  <div className="glass p-5 border-l-2 border-secondary/40 bg-secondary/5">
                    ...
                    <p className="text-sm text-muted">Managing academic and technical initiatives, gaining experience in coordination and execution.</p>
                  </div>
                </div>

                <p className="pt-4 border-t border-theme">
                  Currently exploring <span className="text-accent font-bold">Full-stack, Data Science, ML, and BCI</span>, with the goal of building scalable, impactful, and research-driven technology products.
                </p>
              </div>

              <div className="flex flex-wrap gap-4 pt-4">
                {["Python", "Flask", "React", "Next.js", "Automation", "BCI", "ML"].map((tech) => (
                  <span key={tech} className="px-4 py-2 glass border border-theme text-[10px] font-bold text-muted uppercase tracking-widest rounded-sm hover:border-primary/40 transition-colors cursor-default font-mono">
                    {tech}
                  </span>
                ))}
              </div>
